...
namespace Tourism_Project.Migrations
{
    ...
    [Migration("20260612182719_AddRoomNameToBooking")]
    partial class AddRoomNameToBooking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tourism_Project.Models.Trip", b =>
                {
                    ...
                    b.Property<string>("traveldes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tripplace")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
